    ...
    pageEncoding="ISO-8859-1" isELIgnored="false"%>
 	...
 	<h1 style="background-color:lime;color:maroon;text-align:center; ">Confirmation Page</h1>
 		<table align="center" style="background-color:silver; border-color: red" border="1">
 			...
 			<tr style="text-align: center;color: purple;"><td colspan="2"><b>Persional Details</td></tr>
 			...
 			<tr><td>Date Of Birth</td><td>${pDetails.dob}</td></tr>
 			 <tr style="text-align: center;color: purple;"><td colspan="2"><b>Educational Details</td></tr>
 			 ...
 			 <tr style="text-align: center"><td colspan="2"><input type="submit" value="confirm"/></td></tr>
 	</table>
 	</form:form>
 	</body>